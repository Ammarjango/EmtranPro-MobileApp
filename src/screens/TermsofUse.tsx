...
import {FONT_SIZE_12, FONT_SIZE_16} from '../assets/fonts/typography';
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.heading}>Scope of License</Text>
        <Text style={styles.paragraph}>
          Licensor grants to you a nontransferable license to use the Licensed
          Application on any Apple-branded products that you own or control and
          as permitted by the Usage Rules. The terms of this Standard EULA will
          ...
          by Licensor that replace or supplement the original Licensed
          Application, unless such upgrade is accompanied by a Custom EULA.
          Except as provided in the Usage Rules, you may not distribute or make
          the Licensed Application available over a network where it could be
          ...
          Application from the Apple Device before doing so. You may not copy
          (except as permitted by this license and the Usage Rules),
        ...
        <Text style={styles.heading}>Consent to Use of Data</Text>
        <Text style={styles.paragraph}>
          ...
          Licensed Application. Licensor may use this information, as long as it
          is in a form that does not personally identify you, to improve its
        ...
        <Text style={styles.paragraph}>
          ...
          sole risk. Licensor is not responsible for examining or evaluating the
          content or accuracy of any third-party External Services, and shall
          not be liable for any such third-party External Services. Data
          displayed by any Licensed Application or External Service, including
          ...
          infringes the intellectual property rights of Licensor or any third
          party. You agree not to use the External Services to harass, abuse,
          stalk, threaten or defame any person or entity, and that Licensor is
          not responsible for any such use. External Services may not be
        ...
        <Text style={styles.paragraph}>
          ...
          OF NONINFRINGEMENT OF THIRD-PARTY RIGHTS. NO ORAL OR WRITTEN
